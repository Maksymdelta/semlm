...
echo "Re-rank:"
python rerank.py ~/data/librispeech1/nbests/lat.1.nbest.txt ~/data/librispeech1/dev_clean.ref
...
echo "Test sklearn:"
python sklearn-test.py  ~/data/librispeech1/nbests/lat.1.nbest.txt ~/data/librispeech1/dev_clean.ref

# This script was just for messing around...
# python test-fe.py  ~/data/librispeech1/nbests/lat.1.nbest.txt
